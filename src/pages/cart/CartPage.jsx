...
const buyNowFunction  = async () => {
    if (addressInfo.name === "" || addressInfo.mobileNumber === "" || addressInfo.pincode === "" || addressInfo.address === "") {
                                                ...
                                                <div key={index} className="">
                                                    ...
                                                    <div className="mb-2 flex">
                                                        <div className="min-w-24 flex">
                                                            <button onClick={() => handleDecrement(item)} type="button" className="h-7 w-7">-</button>
                                                            <input
                                                                type="text"
                                                                className="mx-1 h-7 w-9 rounded-md border text-center"
                                                                value={quantity}
                                                            />
                                                            <button onClick={() => handleIncrement(item)} type="button" className="flex h-7 w-7 items-center justify-center">+</button>
